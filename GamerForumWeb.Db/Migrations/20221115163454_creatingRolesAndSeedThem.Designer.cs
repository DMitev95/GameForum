...
namespace GamerForumWeb.Db.Migrations
{
    ...
    [Migration("20221115163454_creatingRolesAndSeedThem")]
    partial class creatingRolesAndSeedThem
    {
            ...
            modelBuilder.Entity("GamerForumWeb.Db.Data.Entities.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 5,
                            CreatedDate = new DateTime(2022, 11, 15, 18, 34, 53, 915, DateTimeKind.Local).AddTicks(39),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 11, 15, 18, 34, 53, 915, DateTimeKind.Local).AddTicks(69),
            ...
            modelBuilder.Entity("GamerForumWeb.Db.Data.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 11, 15, 18, 34, 53, 915, DateTimeKind.Local).AddTicks(121),
                            GameId = 1,
            ...
            modelBuilder.Entity("GamerForumWeb.Db.Data.Entities.PostComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 11, 15, 18, 34, 53, 915, DateTimeKind.Local).AddTicks(165),
                            Likes = 0,
                            PostId = 1,
            ...
            modelBuilder.Entity("GamerForumWeb.Db.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "9197c5d4-8601-4afe-b457-7fc09fe04c57",
                            CreatedOn = new DateTime(2022, 11, 15, 18, 34, 53, 915, DateTimeKind.Local).AddTicks(360),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = "2",
                            ConcurrencyStamp = "aa8ab4fd-d601-488f-9763-53ea825d6989",
                            CreatedOn = new DateTime(2022, 11, 15, 18, 34, 53, 915, DateTimeKind.Local).AddTicks(366),
                            Name = "User"
                        });
                });
